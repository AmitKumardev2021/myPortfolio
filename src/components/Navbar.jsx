...
const Navbar = () => {
  ...
  return (
    <React.Fragment>
      <div className="fixed w-full h-[60px] bg-transparent flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
        ...
        <div className="hidden lg:flex fixed flex-col top-[35%] left-0 ">
          <ul>
            {/* linkedIn */}
            <li className=" w-[160px] h-[40px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-500 bg-blue-600 ">
              <a
